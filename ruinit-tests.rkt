...
(module+ test
  (test-begin
    (test-result-success? (test-equal? 1 1))
    (test-result-success? (test-equal? 'a 'a))
    (test-result-success? (test-equal? '(1 a 2 (3 #f))
                                           '(1 a 2 (3 #f))))
    (test-result-success? (test-equal? (mcons 1 2)
                                           (mcons 1 2)))
    ...
    (test-result-success? (test-eq? 'yes 'yes))
    ...
    (test-result-success? (let ([v (mcons 1 2)])
                                (test-eq? v v)))
